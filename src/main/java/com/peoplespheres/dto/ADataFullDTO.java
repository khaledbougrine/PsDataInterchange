...
public class ADataFullDTO implements Serializable {
    ...
    @Schema(description = "Data name (ex:Username)", example = "Username", required = true)
    @NotBlank(message = "{data.name.not-blank}")
    protected String name;

    @Schema(description = "Data alias (ex:usr_username)", example = "usr_username", required = true)
    @NotBlank(message = "{data.alias.not-blank}")
    protected String alias;

    @Schema(description = "Data field type (ex:text)", required = true,
    ...
    @Schema(description = "Data category alias", required = true)
    ...
    @Schema(description = "Data type array (true/false)", required = true)
    ...
    @Schema(description = "Data required flag (true/false)", required = true)
    ...
    @Schema(description = "Unique identifier of the associated flow", required = true)
