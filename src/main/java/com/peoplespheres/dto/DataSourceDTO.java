...
public class DataSourceDTO extends ADataDTO implements Serializable {
    @Schema(description = "The alias of the category to which this data source is associated (ex:'personal_information')", example = "personal_information", required = true)
