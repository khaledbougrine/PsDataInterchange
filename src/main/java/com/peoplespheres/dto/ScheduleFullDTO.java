...
public class ScheduleFullDTO implements Serializable {
    ...
    @Schema(description = "Scheduler is maintenance active boolean: (true/false)", required = true)
    ...
    @Schema(description = "Scheduler execution time format : hh:mm:ss", example = "2022-12-31T10:15:30", required = true)
